function performSearch() {
    ...
    try {
        // Creates a global regular expression from the search input
...
function performReplace() {
    ...
    try {
        // Replaces all instances of the search pattern with the replacement text
...
function performFormat() {
    ...
    // Capitalizes the first letter of every word using RegEx
